...
class S {
  ...
  /// `Gaza`
  String get gaza {
    return Intl.message('Gaza', name: 'gaza', desc: '', args: []);
  }
  ...
  String get hollywood {
    return Intl.message('Hollywood', name: 'hollywood', desc: '', args: []);
  }
  ...
  /// `More details`
  String get more {
    return Intl.message('More details', name: 'more', desc: '', args: []);
  }
